...
describe("ApiTest", () => {
  describe("buildProxyUrl", () => {
    ...
    it("should return with username and pass if defined", () => {
      ...
      assert.equal(
        Api.prototype.buildProxyUrl(config),
        "https://bob:pass@someplace.com"
      );
    });
  });
  describe("buildUrl", () => {
  ...
  describe("getFilesForTable", () => {
    it("should work without params and get for a tablename", done => {
      ...
      buildTest(
        ...
        ["someTable"],
        "GET",
        "account/self/file/byTable/someTable",
        done
      );
    });
